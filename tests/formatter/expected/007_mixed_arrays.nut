::Mod_ROTU.RNGSpawn <- {
	Day0 = ::MSU.Class.WeightedContainer([
		[2, { Unit = ::Const.World.Spawn.Troops.LegendBasiliskDrone, Max = 1 }],
		[4, { Unit = ::Const.World.Spawn.Troops.FaultFinder, Max = 1 }],
		/////undeads
		[3, { Unit = ::Const.World.Spawn.Troops.LegendDemonHound, Max = 1 }],
	]),
	Day50 = ::MSU.Class.WeightedContainer([
		[4, { Unit = ::Const.World.Spawn.Troops.LegendBasiliskDrone, Max = 2 }],
