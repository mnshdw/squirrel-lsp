			...
			ret.extend([
				{
					...
					text = "[color="
						...
						+ "]+"
						+ this.Math.floor(bonus)
						+ "[/color] armor condition added at start of combat"
				},
				{
					id = 11,
					type = "text",
					...
					text = "[color="
						+ this.Const.UI.Color.PositiveValue
						+ "]+"
						+ this.Math.floor(bonus / 2)
						+ "[/color] helmet condition added at start of combat"
				}
			]);
		} else {
			ret.push({
