function onCombatStarted() {
	...
	actor.m.Sound[this.Const.Sound.ActorEvent.Fatigue] = ["sounds/enemies/ghastly_touch_01.wav"];
	actor.m.Sound[this.Const.Sound.ActorEvent.Flee] = ["sounds/enemies/ghastly_touch_01.wav"];
